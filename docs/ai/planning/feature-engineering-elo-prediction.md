...
- [ ] **Milestone 5**: Baseline Re-evaluation — XGBoost với new features, acc ≥ 60%
...
- [ ] **Task 4.2a**: Loại bỏ bản ghi `<5 ply` và log drop rate theo từng split
- [ ] **Task 4.2b**: Gate chất lượng dữ liệu: pass <=1.5%, warning (1.5%, 3%], fail >3%
...
- [ ] **Task 4.7**: Lock random seed + version hóa artifacts để so sánh công bằng giữa các vòng tối ưu
